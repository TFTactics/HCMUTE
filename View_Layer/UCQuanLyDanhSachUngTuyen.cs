                ...
                if (dr.Cells[0].Value != null)
                {
                    if (Convert.ToBoolean(dr.Cells[0].Value.ToString()))
                    {
                        try
                        {
                            ...
                            Convert.ToInt32(dr.Cells[4].Value.ToString()),Convert.ToInt32(dr.Cells[5].Value.ToString()), dr.Cells[6].Value.ToString(), dr.Cells[7].Value.ToString(), dr.Cells[8].Value.ToString());
                            LoadData();
                            MessageBox.Show("Done");
                        }
                        catch (SqlException)
